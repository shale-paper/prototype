...
//
// schedule ifc_startSwitching  CF ( portalIfc_slave_read_server_readReq_put,
// 				  portalIfc_slave_read_server_readData_get,
// 				  portalIfc_slave_write_server_writeReq_put,
// 				  portalIfc_slave_write_server_writeData_put,
// 				  portalIfc_slave_write_server_writeDone_get,
...
//
// schedule ifc_printSwStats  CF ( portalIfc_slave_read_server_readReq_put,
// 				portalIfc_slave_read_server_readData_get,
// 				portalIfc_slave_write_server_writeReq_put,
// 				portalIfc_slave_write_server_writeData_put,
// 				portalIfc_slave_write_server_writeDone_get,
...
//
// schedule ifc_start_shoal  CF ( portalIfc_slave_read_server_readReq_put,
// 			       portalIfc_slave_read_server_readData_get,
// 			       portalIfc_slave_write_server_writeReq_put,
// 			       portalIfc_slave_write_server_writeData_put,
// 			       portalIfc_slave_write_server_writeDone_get,
...
module mkShoalMultiSimTopRequestProxySynth(id,
					   CLK,
					   RST_N,
  ...
  wire [63 : 0] dut_ifc_startSwitching_timeslot, dut_ifc_start_shoal_cycles;
  wire [31 : 0] dut_ifc_start_shoal_idx,
  ...
  wire [15 : 0] dut_ifc_start_shoal_rate,
		dut_portalIfc_messageSize_size_methodNumber;
  wire [7 : 0] dut_ifc_startSwitching_reconfig_flag,
	       dut_ifc_start_shoal_timeslot;
  wire dut_EN_ifc_printSwStats,
       dut_EN_ifc_startSwitching,
       dut_EN_ifc_start_shoal,
       dut_EN_portalIfc_indications_0_deq,
       dut_EN_portalIfc_indications_1_deq,
       dut_EN_portalIfc_indications_2_deq,
       dut_RDY_ifc_printSwStats,
       dut_RDY_ifc_startSwitching,
       dut_RDY_ifc_start_shoal,
  ...
  // action method ifc_startSwitching
  assign RDY_ifc_startSwitching = dut_RDY_ifc_startSwitching ;

  // action method ifc_printSwStats
  assign RDY_ifc_printSwStats = dut_RDY_ifc_printSwStats ;

  // action method ifc_start_shoal
  assign RDY_ifc_start_shoal = dut_RDY_ifc_start_shoal ;

  // submodule dut
  mkShoalMultiSimTopRequestOutput dut(.CLK(CLK),
				      .RST_N(RST_N),
				      .ifc_startSwitching_reconfig_flag(dut_ifc_startSwitching_reconfig_flag),
				      .ifc_startSwitching_timeslot(dut_ifc_startSwitching_timeslot),
				      .ifc_start_shoal_cycles(dut_ifc_start_shoal_cycles),
				      .ifc_start_shoal_idx(dut_ifc_start_shoal_idx),
				      .ifc_start_shoal_rate(dut_ifc_start_shoal_rate),
				      .ifc_start_shoal_timeslot(dut_ifc_start_shoal_timeslot),
				      ...
				      .EN_ifc_startSwitching(dut_EN_ifc_startSwitching),
				      .EN_ifc_printSwStats(dut_EN_ifc_printSwStats),
				      .EN_ifc_start_shoal(dut_EN_ifc_start_shoal),
				      ...
				      .RDY_ifc_startSwitching(dut_RDY_ifc_startSwitching),
				      .RDY_ifc_printSwStats(dut_RDY_ifc_printSwStats),
				      .RDY_ifc_start_shoal(dut_RDY_ifc_start_shoal));
  ...
  // submodule dut
  assign dut_ifc_startSwitching_reconfig_flag =
	     ifc_startSwitching_reconfig_flag ;
  assign dut_ifc_startSwitching_timeslot = ifc_startSwitching_timeslot ;
  assign dut_ifc_start_shoal_cycles = ifc_start_shoal_cycles ;
  assign dut_ifc_start_shoal_idx = ifc_start_shoal_idx ;
  assign dut_ifc_start_shoal_rate = ifc_start_shoal_rate ;
  assign dut_ifc_start_shoal_timeslot = ifc_start_shoal_timeslot ;
  ...
  assign dut_EN_portalIfc_indications_2_deq =
	     ...
	     memslave_fifoReadAddrGenerator_addrBeatFifo_D_OUT[21:17] ==
	     5'd0 ;
  assign dut_EN_ifc_startSwitching = EN_ifc_startSwitching ;
  assign dut_EN_ifc_printSwStats = EN_ifc_printSwStats ;
  assign dut_EN_ifc_start_shoal = EN_ifc_start_shoal ;
  ...
  // synopsys translate_on
endmodule  // mkShoalMultiSimTopRequestProxySynth
